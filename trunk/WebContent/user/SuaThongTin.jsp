									...
									<table border="0" cellpadding="0" cellspacing="8">
										<tbody>
											...
											<tr>
												...
												%>
												<td width="748" class="infoLogin"><input name="username" type="text" id="Main_txtUserName" style="width: 245px;" value="<%=username%><%=un%>" readonly> <span style="color: #F00">*</span> <span id="Main_reqUserName" style="display: none;">*</span> <span id="Main_regUserName" style="display: none;">*</span></td>
											</tr>
														...
														<tbody>
															<tr>
																<td width="323" class="infoLogin">
																	<p>
																		<input name="full_name" value="<%=fullName%><%=fn%>" type="text" id="Main_txtFirstName" style="width: 240px;"> <span id="Main_reqFirstName" style="display: none;">*&nbsp;</span><span style="color: #F00"><br>*${requestScope.errorFullNameNull }</span><br>
																	</p>
																</td>
																<td width="79" class="infoLogin"><span id="Main_reqLastName" style="display: none;">*</span><strong>Giới tính:</strong><br></td>
																<%
																	boolean isMale = ((UserEntity) pageContext.getAttribute("user",
																				PageContext.SESSION_SCOPE)).isMale();
																		if (isMale) {
											...
											<tr>
												...
												<td class="infoLogin" valign="top"><input name="email" type="text" value="<%=email%><%=e%>" id="Main_txtEmail" style="width: 245px;"> <span id="Main_reqEmail" style="display: none;">*</span> <span id="Main_regEmail" style="display: none;">*</span> <span style="color: #F00">* ${requestScope.errorEmailNull } ${requestScope.errorInvalidEmail }</span></td>
											</tr>
											<tr>
												...
												</select> <span style="color: #F00">*${requestScope.errorYearNotYetChoosen }</span></td>
											</tr>
											<tr>
												...
												</select> <span style="color: #F00">*${requestScope.errorCityNotYetChoosen }</span></td>
											</tr>
