...
<body>
	...
	<div class="container">
        ...
        <div id="menumain">
            ...
            <li id="item_6" class="item menu"><a href="HeDieuHanh.jsp"><span>
            Hệ điều hành
            </span></a>
...
<div class="bag">
   	<div class="tit">
                <a href="TrangChu.jsp"><img src="Image/icon_home.jpg" width="18" height="24" align="absmiddle" border="0"></a> »&nbsp;<a href="HeDieuHanh.jsp">Hệ điều hành</a>&nbsp;»&nbsp;<a href="Unix-Linux.jsp">Unix-Linux</a>
