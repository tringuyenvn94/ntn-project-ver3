                ...
                <div class="content_left">
                    ...
                    <div class="topnew">
                                    ...
                                    <div class="title_topnew">
                                        <a><span>Giới thiệu Website </span></a></div>
                                    <div>
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tbody><tr>
                                                ...
                                                <td class="ctt_top" valign="top">
                                                  <p>&nbsp;</p>
                                                  <p>Information Technology là trang tin tức cập nhật những thông tin mới nhất, những tin nóng về lĩnh vực công nghệ, cập nhật những thông tin công nghệ, những đặc điểm của những sản phẩm mới nhất trên thị trường công nghệ.                                             </p>
                                              <p> Công ty chủ quản của Website này là NTN Coporation Entertainment Education Information Technology là một công ty giải trí, cung cấp các sản phẩm, các ứng dụng giải trí về lĩnh vực công nghệ, hỗ trợ các sản phẩm cho lĩnh vực giáo dục, giải trí. Khách hàng sẽ được cung cấp mọi thông tin, mọi vấn đề mới nhất về công nghệ khi sử dụng những sản phẩm của công ty. NTN Coporation Entertainment Education Information Technology luôn đa dạng các sản phẩm trong lĩnh vực công nghệ thông tin nhằm đáp ứng nhu cầu ngày càng cao của khách hàng.</p>
                                              <p>Information Technology là một website chỉ để cung cấp những thông tin, tin tức công nghệ, không cung cấp các mặt hàng, sản phẩm để khách hàng thực hiện việc mua bán, xem giá trên website. Nếu muốn sử dụng những sản phẩm tiên tiến của công ty, khách hàng truy cập trang web: ntn.vn, hoặc đến trực tiếp địa chỉ: số 1234 đường Nú Tài Nhẫn, Phường 99, Quận 13, TPHCM, điện thoại liên hệ: 0808-0008. Xin chân thành cảm ơn!</p></td>
                                            </tr>
                                        </tbody></table>
