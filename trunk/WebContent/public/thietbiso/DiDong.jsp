...
<div class="bag">
   	<div class="tit">
   					...
   					<%
                        	List<TopicEntity> dulieu = TopicDAO.loadBySubMenu("didong");
                ...
                <a href="trangchu.jsp"><img src="Image/icon_home.jpg" width="18" height="24" align="absmiddle" border="0"></a> »&nbsp;<a href="phancung.jsp">Thiết bị số</a>&nbsp;»&nbsp;<a href="desktop.jsp">Di động</a>
