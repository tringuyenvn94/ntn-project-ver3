...
<div class="bag">
   	<div class="tit">
   					...
   					<%
                        	...
                        	TopicEntity laptop6 = laptop.get(5);
                        	TopicEntity laptop7 = laptop.get(6);
                        	TopicEntity laptop8 = laptop.get(7);
                        	TopicEntity laptop9 = laptop.get(8);
                        	TopicEntity laptop10 = laptop.get(9);
                        	TopicEntity laptop11 = laptop.get(10);
                        	TopicEntity laptop12 = laptop.get(11);
                        	...
                        	pageContext.setAttribute("laptop5", laptop5);
                       		pageContext.setAttribute("laptop6", laptop6);
                        	pageContext.setAttribute("laptop7", laptop7);
                        	pageContext.setAttribute("laptop8", laptop8);
                        	pageContext.setAttribute("laptop9", laptop9);
                        	pageContext.setAttribute("laptop10", laptop10);
                        	pageContext.setAttribute("laptop11", laptop11);
                        	pageContext.setAttribute("laptop12", laptop12);
                        
                        	
                        %>
   									
   									
                <a href="trangchu.jsp"><img src="Image/icon_home.jpg" width="18" height="24" align="absmiddle" border="0"></a> »&nbsp;<a href="phancung.jsp">Phần cứng</a>&nbsp;»&nbsp;<a href="desktop.jsp">Laptop</a>
        
    </div>
       
          <div class="title_article">
                    <a href="load?id=${pageScope.laptop1.id }"><span>
						${pageScope.laptop1.title }
</span></a>
                </div>
                <div>
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tbody><tr>
                            <td class="img_top2">
                                <a href="load?id=${pageScope.laptop1.id }"><img src="${pageScope.laptop1.url_daidien }" width="247" height="265" hspace="3" vspace="3" align="left" border="0"></a>
                            </td>
                        ...
                        <div class="subcontent2">
                            <a href="load?id=${pageScope.laptop2.id }">
                                <img src="${pageScope.laptop2.url_daidien }" height="179" hspace="5" vspace="3" align="left" border="0">
                            </a>
                            <p class="title_ctt">
                                <a href="load?id=${pageScope.laptop2.id }">
									${pageScope.laptop2.title }
                        ...
                        <div class="subcontent2">
                            <a href="load?id=${pageScope.laptop3.id }">
                                <img src="${pageScope.laptop3.url_daidien }" height="171" hspace="5" vspace="3" align="left" border="0">
                            </a>
                            <p class="title_ctt">
                                <a href="load?id=${pageScope.laptop3.id }">
									${pageScope.laptop3.title }
                        ...
                        <div class="subcontent2">
                            <a href="load?id=${pageScope.laptop4.id }">
                                <img src="${pageScope.laptop4.url_daidien }" height="164" hspace="5" vspace="3" align="left" border="0">
                            </a>
                            <p class="title_ctt">
                                <a href="load?id=${pageScope.laptop4.id }">
								${pageScope.laptop4.title }

</a></p>
                            <p class="detail_ctt">
								${pageScope.laptop4.header }
                            </p>
            </div>
                       ...
                       <div class="lines">
                        ...
                        <div class="subcontent2">
                            <a href="load?id=${pageScope.laptop5.id }">
                                <img src="${pageScope.laptop5.url_daidien }" height="150" hspace="5" vspace="3" align="left" border="0">
                            </a>
                            <p class="title_ctt">
                                <a href="load?id=${pageScope.laptop5.id }">
									${pageScope.laptop5.title }

</a></p>
                            <p class="detail_ctt">
								${pageScope.laptop5.header }
                           </p>
            </div>
                       ...
                       <div class="lines">
                        ...
                        <div class="subcontent2">
                            <a href="load?id=${pageScope.laptop6.id }">
                                <img src="${pageScope.laptop6.url_daidien }" height="146" hspace="5" vspace="3" align="left" border="0">
                            </a>
                            <p class="title_ctt">
                                <a href="load?id=${pageScope.laptop6.id }">
										${pageScope.laptop6.title }

 </a></p>
                            <p class="detail_ctt">
									${pageScope.laptop6.header }
                             </p>
            </div>
                       ...
                       <div class="lines">
                        ...
                        <div class="subcontent2">
                            <a href="load?id=${pageScope.laptop7.id }">
                                <img src="${pageScope.laptop7.url_daidien }" height="146" hspace="5" vspace="3" align="left" border="0">
                            </a>
                            <p class="title_ctt">
                                <a href="load?id=${pageScope.laptop7.id }">
							${pageScope.laptop7.title }

</a></p>
                            <p class="detail_ctt"> 
										${pageScope.laptop7.header }
                            </p>
                        </div>
                        ...
                        <div class="subcontent2">
                            <a href="load?id=${pageScope.laptop8.id }">
                                <img src="${pageScope.laptop8.url_daidien }" height="134" hspace="5" vspace="3" align="left" border="0">
                            </a>
                            <p class="title_ctt">
                                <a href="load?id=${pageScope.laptop8.id }"> 
								${pageScope.laptop8.title }

 </a></p>
                            <p class="detail_ctt">
									${pageScope.laptop8.header }
                         </p>
                        </div>
                        ...
                        <div class="subcontent2"><a href="load?id=${pageScope.laptop9.id }"><a href="load?id=${pageScope.laptop9.id }"><img src="${pageScope.desktop9.url_daidien }" height="144" hspace="5" vspace="3" align="left" border="0" /></a>
                          <p class="title_ctt">
                              <a href="load?id=${pageScope.laptop9.id }">
									${pageScope.laptop9.title }

 </a></p>
                            <p class="detail_ctt">
									${pageScope.laptop9.header }
                             </p>
                        </div>
                        ...
                        <div class="subcontent2">
                            <a href="load?id=${pageScope.laptop10.id }">
                                <img src="${pageScope.laptop10.url_daidien }" height="147" hspace="5" vspace="3" align="left" border="0">
                            </a>
                            <p class="title_ctt">
                                <a href="load?id=${pageScope.laptop10.id }">
							${pageScope.laptop10.title }

 </a></p>
                            <p class="detail_ctt">
									${pageScope.laptop10.header }
                            </p>
                        </div>
                        ...
                        <div class="subcontent2">
                            <a href="load?id=${pageScope.laptop11.id }">
                                <img src="${pageScope.laptop11.url_daidien }" height="142" hspace="5" vspace="3" align="left" border="0">
                            </a>
                            <p class="title_ctt">
                                <a href="load?id=${pageScope.laptop11.id }">
					${pageScope.laptop11.title }

 </a></p>
                            <p class="detail_ctt">
						${pageScope.laptop11.header }
                            </p>
                        </div>
                        ...
                        <div class="subcontent2">
                            <a href="load?id=${pageScope.laptop12.id }">
                                <img src="${pageScope.laptop12.url_daidien }" width="287" height="160" hspace="5" vspace="3" align="left" border="0">
                            </a>
                            <p class="title_ctt">
                          <a href="load?id=${pageScope.laptop12.id }">
										${pageScope.laptop12.title }

 </a></p>
                            <p class="detail_ctt">
						${pageScope.laptop12.header }
                            </p>
          </div>
