								...
								<div id="Main_pnlRegister" onkeypress="javascript:return WebForm_FireDefaultButton(event, 'Main_btnRegister')">
									...
									<table border="0" cellpadding="0" cellspacing="8">
										<tbody>
											...
											<tr>
												<td class="infoLogin" nowrap="nowrap"><span>Tên đăng nhập:</span></td>
											...
											<tr>
												...
												<td class="infoLogin">
													<table width="751" border="0" cellpadding="0" cellspacing="0" class="infoLogin">
														<tbody>
															<tr>
																<td width="430" class="infoLogin">
																	<p>
																		<input name="full_name" value="<%=fullName%>" type="text" id="Main_txtFirstName" style="width: 400px;"> <br> 
																		<span id="Main_reqFirstName" style="display: none;">*&nbsp;</span>*<%=errorFullNameNull%><br>
																	</p>
																</td>
																<td width="1" class="infoLogin"><span id="Main_reqLastName" style="display: none;">*</span><br></td>
																<td width="10" align="right" class="infoLogin"></td>
																<td width="189" class="infoLogin"><span id="Main_slcSex"><input id="Main_slcSex_0" type="radio" name="sex" value="male" <%=checkedMale%>><label for="Main_slcSex_0">Nam</label><input id="Main_slcSex_1" type="radio" name="sex" value="female" <%=checkedFemale%>><label for="Main_slcSex_1">Nữ</label></span></td>
															</tr>
														</tbody>
													</table>
												</td>
