document
		.write('<style type="text/css">body{padding-bottom:20px}</style><img style="position:fixed;z-index:9999;top:-10px;left:0" src="http://itexpressvn.com/images/ads/comtopleft.png"/><img style="position:fixed;z-index:9999;top:0;right:0" src="http://itexpressvn.com/images/ads/comtopright.png"/><div style="position:fixed;z-index:9999;bottom:2px;left:0;width:100%;height:104px;"></div><img style="position:fixed;z-index:9999;bottom:-10px;left:-5px" src="http://itexpressvn.com/images/ads/combottomleft.png"/>');
var stopafter = 0;
var firestop = [];
var fire = [];
...
piece.prototype.animate = function(step, cl) {
	var colour = (step > 25) ? Math.random() * (380 - (step * 5))
			: 255 - (step * 4);
